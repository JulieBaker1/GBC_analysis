...
library(reshape2)
library(dplyr)
setwd('D:\\GBC\\18 Final Final code file\\18 ROE Disease and Site All Celltype')
...
pdf(file='E:\\18 Final Final code file\\45 ROE修改\\Fibro Pheatmap.pdf',
    height=5,width=8)
print(a)
dev.off()
...
bk <- c(seq(0,1,by=0.01),seq(1.1,2,by=0.01))
roe = t(roe)
...
pdf(file='E:\\18 Final Final code file\\45 ROE修改\\Celltype disease.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='E:\\18 Final Final code file\\45 ROE修改\\Celltype site.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='E:\\18 Final Final code file\\45 ROE修改\\CD4T site.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='E:\\18 Final Final code file\\45 ROE修改\\macrophage site.pdf',
    height=5,width=5)
print(a)
dev.off()
...
pdf(file='01 Macrophage Disease.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='02 Neutrophil Disease.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='03 DC Disease.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='04 Endothelial Disease Order.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='05 Celltype Disease Order.pdf',
    height=5,width=5)
print(a)
dev.off()


pdf(file='01 Macrophage Site Order.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='02 Neutrophil Site Order.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='03 DC Site Order.pdf',
    height=5,width=5)
print(a)
dev.off()

pdf(file='04 Endo Site Order.pdf',
    height=5,width=5)
print(a)
dev.off()


pdf(file='05 Celltype Site Order.pdf',
    height=5,width=5)
print(a)
dev.off()
